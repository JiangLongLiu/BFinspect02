...
public class RoleAction extends BaseAction<Role> {
	...
	public String showImpower() {
		//得到所有的资源
		List<com.bf.entity.Resource> resources = rese.findAll("from com.bf.entity.Resource res where res.flag=1");
	...
	public String impower() {
		Set<com.bf.entity.Resource> resourceSet = new HashSet<com.bf.entity.Resource>();
		role = rs.findById(id);
		if(resourcesId!=null && resourcesId.length>0) {
			for(Integer resId : resourcesId) {
				com.bf.entity.Resource res = rese.findById(resId);
				resourceSet.add(res);
			}
		}
